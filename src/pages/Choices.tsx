  ...
  return (
    <div id="choice-body">
      ...
      <div id="wait-typewriter">
        Embark on your exciting journey by selecting either a basic or a
        detailed questionnaire. This will help you discover the career path that
        aligns perfectly with your interests, skills, and aspirations!
        <CherryBlossom />
      </div>
      <div id="wait-twice">
        <div id="basic">
          ...
          <br />
          <br />
          <div id="get-started-basic">
            <button onClick={() => setPage("/basic-questions")}>
              Get Started
            </button>
          </div>
        </div>
        <div id="detailed">
          ...
          <br />
          <br />
          <div id="get-started-detailed">
            <button onClick={() => setPage("/detailed-questions")}>
              Get Started
            </button>
          </div>
        </div>
